const features = [
  {
    ...
    description: "Explore local campus vendors and find your favorite meals.",
    icon: (
  ...
  },
  {
    ...
    description: "Track your order from preparation to delivery in real time.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    title: "In-app Chat",
    description: "Communicate directly with vendors for custom orders or questions.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Fast delivery directly to your campus location.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
